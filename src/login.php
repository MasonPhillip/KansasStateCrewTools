...
<body>
	...
	<div class="centerBox">
		<div style="margin-top: 12%;">
			Name
			<input type="textbox" style="margin: auto; height: 30px;" id="nameBox" name="nameBox" value="Mason"> </input>
		</div>
		<div style = "margin-top:2% ;">
			Password
			<input type="password" style="height: 30px;" id="passwordBox" name="passwordBox" value = "a"> </input>
		</div>
